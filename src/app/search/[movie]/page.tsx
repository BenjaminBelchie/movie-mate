...
import AddToWatchlistIconButton from "~/app/_components/Watchlist/add-to-watchlist-icon-button";
...
export default async function SearchPage({
  ...
  let watchlist: UserWatchlist | undefined | null;
  let filmsOnWatchlist: FilmOnWatchlist[];
  let friends:
    | Prisma.FriendGetPayload<{ include: { friend: true } }>[]
    | undefined;
  if (session) {
    friends = await api.friend.findUserFriends.query();
    watchlist = await api.watchlist.getUserWatchlist.query({
                        ...
                        <div className="mt-2 flex gap-2 md:mb-2 md:mt-0">
                          ...
                          {session && watchlist && (
                            <AddToWatchlistIconButton
                              ...
                              isInWatchlist={isFilmOnWatchlist}
